...
public class SeckillServiceImpl implements SeckillService{
	...
	private Logger logger = Logger.getLogger(SeckillServiceImpl.class.getName());
	//混淆 md5盐值字符串，用于混淆MD5
	private final String slat = "fadsfdsfjasdofje23r034rsdjfas1@##$%@#$";
	 ...
	 * 2.保证事务方法的执行时间尽可能短，不要穿插其它的网络操作，RPC/HTTP请求
	 * 或者剥离事务方法外部
	...
	public SeckillExecution executeSeckill(long seckillId, long userPhone, String md5)
		...
		try {
			...
			throw e1;
		} catch(RepeatedKillException e2){
			throw e2;
		} catch (Exception e) {
